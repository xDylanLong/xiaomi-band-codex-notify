...
输出文件为 `android-companion/releases/小米手环Codex通知-v0.3.7.apk`。
...
已有 APK：`releases/小米手环Codex通知-v0.3.7.apk`。如果手机已安装旧签名的 v0.3.1，需要先卸载一次再安装；之后版本可直接覆盖升级。安装命令和完整内容类型见 [`../docs/usage.md`](../docs/usage.md)。
