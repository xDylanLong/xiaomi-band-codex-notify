...
[下载 Android App v0.3.5](https://github.com/xDylanLong/xiaomi-band-codex-notify/releases/latest/download/xiaomi-band-codex-notify-v0.3.5.apk)　·　[查看 GitHub 仓库](https://github.com/xDylanLong/xiaomi-band-codex-notify)　·　[查看完整使用指南](docs/usage.md)
...
在 Android 手机上安装 [小米手环 Codex 通知 APK](https://github.com/xDylanLong/xiaomi-band-codex-notify/releases/latest/download/xiaomi-band-codex-notify-v0.3.5.apk)，打开后允许通知权限。
